// src/pages/GameDetailsPageEPL.jsx
import React, { useState, useEffect } from "react";
import { useParams } from "react-router-dom";
import TickerEPL from "./TickerEPL";

const GameDetailsPageEPL = () => {
        ...
        <div className="bg-gray-700 rounded-2xl shadow-lg p-6 mb-6 w-full max-w-6xl">
          ...
          {gameDetail.situation.lastPlayText && (
            <div className="mt-2 bg-gray-800 rounded-xl p-4 text-gray-300">
              <p>
                <span className="font-bold text-white">Last action:</span>{" "}
                {gameDetail.situation.lastPlayText}
              </p>
            </div>
          )}
...
export default GameDetailsPageEPL;